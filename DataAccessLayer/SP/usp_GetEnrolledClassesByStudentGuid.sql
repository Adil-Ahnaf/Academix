...
GO
CREATE OR ALTER PROCEDURE [dbo].[usp_GetEnrolledClassesByStudentGuid] 
...
BEGIN
	...
	INNER JOIN [dbo].[StudentEnrollments] AS SE ON SE.StudentId = S.Id
	...
	WHERE S.StudentGuid = @StudentGuid;
